        ...
        {showNotifications && (
          <>
            ...
            <motion.div
              ...
              className="app-notification-panel fixed top-16 right-[17px] z-50 w-80 max-h-[400px] bg-[var(--surface)] rounded-2xl shadow-2xl border border-[var(--border)] overflow-hidden"
            >
